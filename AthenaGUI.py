...
layout = [[sg.Text("Athena")],
         [sg.Text("Made by GUARDESK Security LTD.")],
         [sg.Text("Insert target URL(i.e. https://website.com):")],
         [sg.InputText()],
         [sg.Submit(), sg.Cancel()]
         ]
window = sg.Window(title="Athena XSS Vulnerability Scanner", layout=layout, margins=(100,150))
url = window.read()[1][0]
